...
const Contact = () => {
    ...
    return (
        <BannerLayout>
            <div>
                <Head>
                    <script type="text/javascript" src="../constants/functions.js"></script>
                </Head>
            </div>
            <div className=" px-4 py-2">
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-5 text-xs">
                        <div className="card_stylings w-full md:w-1/2 p-5 md:p-6 lg:p-8 flex flex-col gap-y-4">
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <span className='text-LightGray md:text-sm'>{DETAILS.Age}</span>
                            </div>
                        </div>
                        <div className="card_stylings rounded-xl w-full md:w-1/2 p-5 md:p-6 lg:p-8 flex flex-col gap-y-4">
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <span className='text-LightGray text-sm'>Alfrethanov Christian Wijaya</span>
                            </div>
                            <div className="flex justify-between items-center">
                ...
                <div className="h-16 w-full card_stylings text-xl sm:text-3xl flex gap-x-8 sm:gap-x-16 items-center justify-center text-Snow">
                    ...
                    <a className='hover:scale-125 ease-in-out duration-700 hidden sm:block' href={SOCIAL_LINKS.INSTAGRAM} target='_blank' rel="noreferrer"><FaInstagram /></a>
                </div>
